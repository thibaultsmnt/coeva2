...
from coeva2_scaled.venus_attack import attack
from coeva2_scaled import venus_constraints
from coeva2_scaled.venus_encoder import VenusEncoder
...
output_dir = "../out/venus_attacks/coeva2_all_random_fitness_scaled_low_tol"
seed = 0
offset = 0
threshold = 0.24
n_jobs = -1
...
constraints = venus_constraints.evaluate(X_initial_states, encoder)
