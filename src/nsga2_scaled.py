...
from nsga2_scaled.venus_attack import attack
from nsga2_scaled import venus_constraints
from nsga2_scaled.venus_encoder import VenusEncoder
...
if __name__ == "__main__":
    ...
    results_df.to_csv(output_dir + "/nsga2_scaled.csv", index=False)
